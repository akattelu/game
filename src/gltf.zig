...
pub const GltfViewer = struct {
    gltf_mesh_vertices: ?[]terrain.Vertex = null,
    gltf_mesh_indices: ?[]u16 = null,

    pub fn init(allocator: std.mem.Allocator, path: []const u8) !GltfViewer {
        ...
        return GltfViewer{
            .gltf_mesh_vertices = try vertices.toOwnedSlice(allocator),
            .gltf_mesh_indices = try indices.toOwnedSlice(allocator),
        };
    }
};
